// app.js (Final Fix - Corrected Order)

const $ = (s, r = document) => r.querySelector(s);
const $$ = (s, r = document) => [...r.querySelectorAll(s)];

// ==========================================
// 1. DATA & KONFIGURASI (WAJIB DI ATAS)
// ==========================================
const TARGET_DONASI = 42000000;
const TERKUMPUL_SAAT_INI = 9519843;

const POPUP_IMAGES_LIST = ["assets/foto/1e.png"]; // Ganti sesuai file Anda
...
// DATA HADITS & DOA (Ditaruh di atas agar terbaca fungsi di bawah)
const HADITHS = [
...
const TRANSLATIONS = {
  id: {
    ...
    dedication_check: "Niatkan pahala untuk", dedication_target: "Orang Tua / Almarhum?", dedication_label: "Nama Orang Tua / Almarhum", dedication_placeholder: "Contoh: Bpk. Fulan bin Fulan",
